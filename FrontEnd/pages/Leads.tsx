...
import { Lead, Tag, CustomFieldConfig, CustomFieldType, Interaction, InteractionType } from '../types';
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <form onSubmit={handleSubmit} className="p-6 overflow-y-auto flex-1">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="md:col-span-2">
                                    <label className="block text-sm font-medium text-gray-700 mb-1">{t('leads.table.name')}</label>
                                    <input 
                                        type="text" 
                                        required
                                        value={formData.name}
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-sm font-medium text-gray-700 mb-2">{t('leads.form.tags')}</label>
                                    <div className="flex flex-wrap gap-2">
                                        {tags.map((tag: Tag) => {
                    ...
                    <div className="pt-6 mt-6">
                        <button 
                            type="submit" 
                            className="w-full py-2.5 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 shadow-sm transition-colors"
                        >
                            {t('common.save')}
                        </button>
                    </div>
            ...
            <div className="flex gap-2 overflow-x-auto w-full md:w-auto scrollbar-hide py-1">
                ...
                {tags.map(tag => (
                    <button
                        ...
                        className={`whitespace-nowrap px-3 py-1.5 rounded-full text-xs font-medium border transition-all flex items-center gap-1.5 ${
