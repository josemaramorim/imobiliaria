...
const Login = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const emailRef = useRef<HTMLInputElement | null>(null);
            ...
            setError(t(err.message || 'auth.error.generic'));
            ...
            setIsLoading(false);
                ...
                // handle axios-style error responses if present
                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-200">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        {error && (
                            ...
                            {error && (
                                <div role="alert" aria-live="polite" className="bg-red-50 border-l-4 border-red-400 p-4 flex items-start gap-3">
                        <div>
