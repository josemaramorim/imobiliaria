...
import { Visit, Lead, Tag, Tenant, Property, Opportunity, User, CustomFieldConfig, ApiKey, Webhook, GlobalSettings, SubscriptionPlan, Invoice, PaymentGateway, PaymentGatewayId } from './types';
import { MOCK_TENANTS, MOCK_TEAM, MOCK_CUSTOM_FIELDS, MOCK_LEAD_CUSTOM_FIELDS, MOCK_PLANS, MOCK_INVOICES, MOCK_PAYMENT_GATEWAYS } from './constants';
