...
const ptBRTranslations = {
  ...
  'login.forgot': 'Esqueceu a senha?', 'login.submit': 'Entrar na Plataforma', 'auth.error.invalid': 'E-mail ou senha incorretos.', 'auth.error.invalid_credentials': 'E-mail ou senha incorretos.',
  ...
  'common.back_to_login': 'Voltar para o Login', 'common.loading': 'Carregando...',
  ...
  'visit.form.property': 'Imóvel (Opcional)', 'visit.form.select_property_placeholder': 'Selecione um imóvel...', 'visit.form.property_title': 'Imóvel Relacionado (Opcional)', 'visit.form.notes': 'Observações',
  'visit.form.select_lead_placeholder': 'Selecione um cliente...',
  ...
  'saas.switch.confirm': 'Confirmar e Acessar', 'saas.back_to_admin': 'Voltar à Administração',
  'saas.table.name': 'Nome do Tenant', 'saas.table.domain': 'Domínio',
