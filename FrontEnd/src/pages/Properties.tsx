...
import { Property, PropertyStatus, CustomFieldConfig, CustomFieldType, UserRole, Visit } from '../types/types';
import { MapPin, Bed, Bath, Expand, Filter, Plus, X, Upload, Image as ImageIcon, Trash2, CheckSquare, Square, ChevronDown, Settings, Edit2, AlertTriangle, Search, Calendar, User, Save, SlidersHorizontal, List, Building } from 'lucide-react';
        ...
        <div className="group bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow flex flex-col h-full">
            <div className="relative h-48 overflow-hidden bg-gray-100 flex-shrink-0">
                ...
                <div className="absolute top-3 left-3">
                    <span className={`px-2.5 py-1 rounded-md text-xs font-semibold shadow-sm ${property.status === PropertyStatus.AVAILABLE ? 'bg-green-500 text-white' :
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-500 mt-0.5">
                                {initialData ? 'Atualize os dados do imóvel' : 'Adicione um novo imóvel ao catálogo'}
                            </p>
                        </div>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">{t('properties.form.title')} <span className="text-red-500">*</span></label>
                                        <input
                                            type="text"
                                            required
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">{t('properties.form.address')} <span className="text-red-500">*</span></label>
                                        <input
                                            type="text"
                                            required
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">{t('properties.form.price')} <span className="text-red-500">*</span></label>
                                            <div className="relative">
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-1">{t('properties.form.area')} <span className="text-red-500">*</span></label>
                                            <input
                                                type="number"
                                                required
                                                min="0"
                        ...
                        {quickStatusTags.map((tag) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`whitespace-nowrap px-3 py-1.5 rounded-full text-xs font-medium border transition-all ${isActive
                                        ? 'bg-indigo-100 text-indigo-700 border-indigo-200'
