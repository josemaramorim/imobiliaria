import { Tenant, User, UserRole, Property, PropertyStatus, Lead, Opportunity, OpportunityStage, Tag, ApiKey, CustomFieldConfig, Permission, Visit, Webhook, SubscriptionPlan, Invoice, PaymentGateway } from './types';
